...
import model.novo.BusaoAdapterMedianeira;

/**
 *
 * @author Veronika
 */
public class RodoviariaNew extends javax.swing.JFrame {

    IVendas busao = null;
    
    public RodoviariaNew() {
        initComponents();
    }
    ...
    private void jButtonGynActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGynActionPerformed
        try {
            if(!jTextFieldPoltronaGyn.getText().isEmpty()){
                boolean pol = false;
                busao.alocarPoltronas(jRadioButtonTrueGyn.isSelected(), Integer.parseInt(jTextFieldPoltronaGyn.getText()));
            }
            jTextAreaSaidaGyn.setText(busao.miniatura());
        } catch (Exception e) {
    ...
    private void jButtonPalmasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalmasActionPerformed
        try {
            if(!jTextFieldPoltronaPalmas.getText().isEmpty()){
                boolean pol = false;
                busao.alocarPoltronas(jRadioButtonFalsePalmas.isSelected(), Integer.parseInt(jTextFieldPoltronaPalmas.getText()));
            }
            jTextAreaSaidaPalmas.setText(busao.miniatura());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e.getMessage(), "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButtonCtriarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCtriarActionPerformed
        busao = new BusaoAdapterMedianeira(jTextFieldEtinerario.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RodoviariaNew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RodoviariaNew().setVisible(true);
            }
        });
    }
